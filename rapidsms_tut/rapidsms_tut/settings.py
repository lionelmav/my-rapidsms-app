...
SECRET_KEY = '0vvaxdd2siw_fe_e!n&1hv7fr&b6bx5x!yse2asr8r)i@&_8i8'
...
RAPIDSMS_HANDLERS = (
    ...
    'rapidsms.contrib.handlers.handlers.myhandlers.HelpHandler',
    'rapidsms.contrib.handlers.handlers.myhandlers.SumHandler',
    )
